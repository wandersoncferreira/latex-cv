...
\begin{tabular}{L!{\VRule}R}
  Emacs Lisp& Maintainer of helm-spotify-plus. Contributor to pomidor,
  organic-green, and many fixes in other projects\\

  Clojure& Regular contributor to spec-tools, and small contributions
  in other projects e.g. reitit, depstar, clara-rules. \\
\end{tabular}
